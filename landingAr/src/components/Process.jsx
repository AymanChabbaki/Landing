...
const steps = [
  {
    num: '01',
    title: 'التدقيق المستندي المسبق',
    desc: 'تحليل شامل لملف الاستيراد الخاص بك وتحديد كافة مخاطر عدم المطابقة الجمركية قبل انطلاق الشحنة.',
    detail: 'الفاتورة التجارية، قائمة التعبئة، شهادة المنشأ، وتراخيص الاستيراد - يتم تدقيق كل وثيقة بعناية فائقة.',
    icon: (
  ...
  },
  {
    ...
    desc: 'مراجعة وتصحيح الوثائق قبل شحن البضائع، مع إيداع ومصادقة الملف في نظام بورتنيت (PortNet).',
    detail: 'التصريح الاستباقي، المصادقة عبر PortNet B2B، وتصحيح ترميز البنود الجمركية لتفادي المفاجآت.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6">
  ...
  {
    num: '03',
    title: 'المرافقة في التخليص الجمركي',
    desc: 'الإفراج السريع عن بضائعك وتسليمها في المواعيد المحددة مع الحفاظ التام على هامش أرباحك.',
    detail: 'إذن الرفع السريع، التنسيق المباشر مع المعشرين، وتتبع حي حتى وصول البضائع إلى مخازنك بالمغرب.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6">
    ...
    <section id="process" className="relative bg-white pt-8 pb-4 sm:py-32 overflow-hidden">
      ...
      <div className="max-w-[1100px] mx-auto px-6 sm:px-12">
        ...
        <div ref={r1} className="reveal-el mb-8 md:mb-20">
          <span className="text-xs font-bold tracking-widest text-[#0159A3] uppercase mb-4 block">
            خطوات العمل
          </span>
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
            <h2 className="font-heading font-bold text-[clamp(2.3rem,4.5vw,3.6rem)] leading-[1.12] tracking-tight text-[#002B49]">
              نظامنا الاستباقي في <br />
              <span className="text-[#0159A3]">3 خطوات متكاملة</span>
            </h2>
            <p className="text-base text-slate-500 max-w-[340px] sm:text-left leading-relaxed pb-1">
              منهجية مجربة في أكثر من 500 شحنة لتأمين عمليات الاستيراد الخاصة بك.
            </p>
          </div>
        ...
        <div ref={r2} className="reveal-el">
          ...
          <div className="relative hidden md:block mb-0">
            <div className="absolute right-[calc(16.67%+16px)] left-[calc(16.67%+16px)] top-8 h-[2px] bg-slate-100 z-0">
              <div
                className="h-full bg-gradient-to-l from-[#0159A3] to-[#FFC90D] transition-all duration-700 ease-in-out"
                ...
                >
                  ...
                  <div className="flex md:flex-col items-center gap-4 md:gap-3 mb-2 md:mb-6 w-full">
                    ...
                    <div className="md:text-center">
                      <span className="text-[11px] font-bold tracking-widest uppercase text-slate-400">الخطوة {step.num}</span>
                    </div>
                  </div>
