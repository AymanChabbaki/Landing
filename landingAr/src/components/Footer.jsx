...
/* ─── Social config ─── */
const SOCIALS = [
  { icon: FacebookIcon, href: "https://www.facebook.com/ULTex.ma", label: "فيسبوك (Facebook)", color: "#1877F2" },
  { icon: InstagramIcon, href: "https://www.instagram.com/ult.ex", label: "انستغرام (Instagram)", color: "#E1306C" },
  { icon: LinkedinIcon, href: "https://ma.linkedin.com/company/ultex", label: "لينكدإن (LinkedIn)", color: "#0A66C2" },
  { icon: TikTokIcon, href: "https://www.tiktok.com/@ul.tex", label: "تيك توك (TikTok)", color: "#ffffff" },
  { icon: YoutubeIcon, href: "https://youtube.com/@joinultex", label: "يوتيوب (YouTube)", color: "#FF0000" },
  { icon: MailIcon, href: "mailto:contact@ultex.ma", label: "البريد الإلكتروني", color: "#FFC90D" },
]
...
const NAV_LINKS = [
  ...
  { label: "خطوات العمل", id: "process" },
  { label: "النتائج والأرقام (80%)", id: "comparison" },
  { label: "آراء العملاء", id: "testimonials" },
  { label: "التأهيل VIP", id: "form-section" },
]
...
export default function Footer() {
  ...
  const css = `
        ...
        .footer-border-anim { transform-origin: right; animation: footer-border-draw 1s cubic-bezier(0.16,1,0.3,1) 0.3s both; }
        .footer-col-0       { animation: footer-from-right 0.8s cubic-bezier(0.16,1,0.3,1) 0.5s  both; }
        .footer-col-1       { animation: footer-from-left  0.8s cubic-bezier(0.16,1,0.3,1) 0.65s both; }
        .footer-col-2       { animation: footer-from-right 0.8s cubic-bezier(0.16,1,0.3,1) 0.8s  both; }
        .footer-col-3       { animation: footer-from-left  0.8s cubic-bezier(0.16,1,0.3,1) 0.95s both; }
        .footer-bottom      { animation: footer-fade-up    0.7s ease 1.1s both; }

        .footer-mob-logo   { animation: footer-fade-up 0.7s ease 0.4s both; }
        .footer-mob-col-l  { animation: footer-from-right 0.7s cubic-bezier(0.16,1,0.3,1) 0.55s both; }
        .footer-mob-col-r  { animation: footer-from-left  0.7s cubic-bezier(0.16,1,0.3,1) 0.7s  both; }
          ...
          <div className="relative w-[88%] mx-auto" style={{ zIndex: 2 }}>
            ...
            <div className={`flex flex-col items-center gap-1 pb-6 text-center ${triggered ? "footer-mob-copy" : ""}`}
              ...
              <span className="font-body" style={{ color: "rgba(255,255,255,0.45)", fontSize: "11px", fontWeight: 300 }}>
                © 2026 ultex لمرافقة الاستيراد والتصدير. جميع الحقوق محفوظة.
              </span>
              <span className="font-body" style={{ color: "rgba(255,255,255,0.45)", fontSize: "11px", fontWeight: 300 }}>
