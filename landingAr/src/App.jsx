    ...
    <>
      ...
      >
        <div className="flex items-center gap-3 px-5 py-3 rounded-2xl bg-slate-900 text-white text-sm font-semibold shadow-2xl">
          ...
          <span>جاري توجيهك إلى استمارة VIP...</span>
      ...
      >
        <button
          ...
          className="group flex items-center gap-3 px-6 py-3.5 rounded-full font-heading font-bold text-sm text-slate-950 shadow-2xl hover:scale-105 active:scale-95 transition-all duration-200 relative overflow-hidden"
          style={{
        ...
        >
          ...
          <span className="relative z-10 tracking-wide">
            تأمين شحنة الاستيراد والتصدير الخاصة بي
          </span>
