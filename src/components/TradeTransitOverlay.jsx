      ...
      <div className="relative z-10 w-full max-w-[1050px] px-6 flex flex-col items-center gap-8">
        ...
        <div className="flex items-center gap-3 px-5 py-2 rounded-full bg-slate-900/90 border border-brand-blue/30 shadow-[0_0_30px_rgba(1,89,163,0.3)] backdrop-blur-md">
          ...
          <span className="text-xs font-mono font-bold tracking-widest text-slate-200 uppercase">
            ULTEX PORTNET // COMMAND CENTER CASABLANCA
          </span>
        </div>
        ...
        <div className="relative w-full h-[220px] flex items-center justify-center my-2">
          ...
          <div className="absolute left-[5%] top-[10px] animate-plane-transit flex items-center gap-3">
            <div className="relative group">
              <div className="absolute -inset-3 rounded-full bg-brand-blue/40 blur-xl animate-pulse" />
              <img
                src="/avion.png"
                alt="Fret Aérien Ultex"
                className="h-24 sm:h-32 w-auto object-contain filter drop-shadow-[0_20px_40px_rgba(1,89,163,0.9)] transform -rotate-6"
              />
            </div>
            <div className="hidden sm:flex flex-col p-3 rounded-2xl bg-slate-900/90 border border-brand-blue/40 shadow-2xl backdrop-blur-md">
              <span className="text-[10px] font-mono font-bold tracking-widest text-brand-gold uppercase">VOIE AÉRIENNE</span>
              <span className="text-xs font-extrabold text-white">TRANSIT EXPRESS 24H</span>
            </div>
          </div>

          {/* 🚢 Boat Asset Sailing Animation */}
          <div className="absolute left-[0%] bottom-[0px] animate-ship-transit flex items-center gap-3">
            <div className="relative group">
              <div className="absolute -inset-3 rounded-full bg-brand-gold/30 blur-xl animate-pulse" />
              <img
                src="/boat.png"
                alt="Maritime PortNet Ultex"
                className="h-24 sm:h-32 w-auto object-contain filter drop-shadow-[0_20px_40px_rgba(0,0,0,0.95)]"
              />
            </div>
            <div className="hidden sm:flex flex-col p-3 rounded-2xl bg-slate-900/90 border border-brand-gold/40 shadow-2xl backdrop-blur-md">
              <span className="text-[10px] font-mono font-bold tracking-widest text-brand-blue-light uppercase">VOIE MARITIME</span>
              <span className="text-xs font-extrabold text-white">PORTNET CLAIRANCE 100%</span>
            </div>
          </div>
        ...
        <div className="w-full max-w-[540px] p-6 rounded-3xl bg-slate-900/95 border-2 border-brand-gold/60 shadow-[0_25px_60px_rgba(0,0,0,0.7)] backdrop-blur-2xl flex flex-col gap-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex flex-col">
              <span className="text-xs font-mono font-bold text-slate-400 tracking-wider uppercase">SÉCURISATION PORTNET</span>
              <span className="text-sm font-extrabold text-white">Pré-Validation Douanière</span>
            </div>
            <div className="flex items-baseline gap-1 text-brand-gold font-mono font-black text-2xl">
              <span>{progress}</span>
          ...
          <div className="grid grid-cols-2 gap-2 pt-2 border-t border-slate-800/80 text-[11px] font-semibold text-slate-300">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>Accès Formulaire VIP</span>
            </div>
          </div>
